  ...
  return (
    <main>
      <section className="next-video-hero">
        <video autoPlay muted loop playsInline preload="metadata" aria-label="Pinkora Dev introduction">
          <source src="/Intro-1.mp4" type="video/mp4" />
        </video>
      </section>
      <section className="next-home-intro next-container">
      ...
      <section className="next-section next-container">
        ...
        <div className="next-card-grid next-project-grid">
          {projects.map(([title, description, href], index) => (
            <Link className="next-project-card" href={href} key={title}>
